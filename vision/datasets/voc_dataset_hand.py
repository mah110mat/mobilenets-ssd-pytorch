...
class VOCDataset:
	...
	def _get_annotation(self, image_id):
		...
		try:
			annotation_file = "../dataset/hand/xml/" + f"train/{image_id}.xml"
			...
			annotation_file = "../dataset/hand/xml/" + f"valid/{image_id}.xml"
	...
	def _read_image(self, image_id):
		...
		try:
			...
			image_file = "../dataset/hand/images/" + f"train/{image_id}.jpg"

			image = cv2.imread(str(image_file))
			image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
		except:
			# image_file = "./data/VOCdevkit/test/VOC2007/" + f"JPEGImages/{image_id}.jpg"
			image_file = "../dataset/hand/images/" + f"valid/{image_id}.jpg"
